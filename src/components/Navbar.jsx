...
function Navbar({ darkMode, setDarkMode, themeColor, setThemeColor }) {

  const [showModal, setShowModal] = useState(false);
  const [selectedTheme, setSelectedTheme] = useState("");

  const colors = [
    { name: "Ocean Theme", value: ["#0077be", "#00aaff", "#00d4ff"], text: "#ffffff" },
    { name: "Sunset Theme", value: ["#ff5e5b", "#ffb400", "#ff8c42"], text: "#333333" },
    { name: "Forest Theme", value: ["#2d6a4f", "#52b788", "#95d5b2"], text: "#ffffff" },
    { name: "Lavender Theme", value: ["#9b5de5", "#f15bb5", "#fee440"], text: "#333333" },
    { name: "Moon Theme", value: ["#1a1a2e", "#162447", "#1f4068"], text: "#ffffff" },
  ];

  // Navbar class dynamically updates based on dark mode + theme color
 const navbarStyle = {
    background: themeColor.colors.length > 1
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
              <li className="nav-item">
                <a className="nav-link" href="#home" style={{ color: themeColor.text }}>
                  Home
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#about" style={{ color: themeColor.text }}>
                  About
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#projects" style={{ color: themeColor.text }}>
                  Projects
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#contact" style={{ color: themeColor.text }}>
                  Contact
                </a>
              </li>
